    ...
    @Override protected void onCreate(Bundle savedInstanceState){
        ...
        if(user==null){
            ...
            try {
                ...
                // START BACKGROUND DEVICE SYNC SERVICE
                Intent syncServiceIntent = new Intent(this, DeviceSyncService.class);
                startService(syncServiceIntent);
                android.util.Log.d("DashboardActivity", "DeviceSyncService started");
